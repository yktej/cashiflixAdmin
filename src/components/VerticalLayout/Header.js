                ...
                <header id="page-topbar">
                    <div className="navbar-header">
                        <div className="d-flex">
                            ...
                            {process.env.REACT_APP_HIDE_UNWANTED && ( <>
                            ...
                            {process.env.REACT_APP_HIDE_UNWANTED && <MegaMenu />}
                        </div>
                        ...
                        {process.env.REACT_APP_HIDE_UNWANTED &&   ( <>
                            ...
                            {process.env.REACT_APP_HIDE_UNWANTED && <LanguageDropdown />}
                            ...
                            {process.env.REACT_APP_HIDE_UNWANTED &&  <NotificationDropdown /> }
